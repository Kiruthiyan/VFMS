...
import { useRole } from "@/lib/trip-role-context";
import TripRoleSwitcher from "@/components/TripRoleSwitcher";
    ...
    const fetchTrips = async () => {
        ...
        try {
            ...
            if (currentUser.role === "SYSTEM_USER") {
                response = await api.get(`/api/trips/requester/${currentUser.id}/history`);
            } else if (currentUser.role === "DRIVER") {
                response = await api.get(`/api/trips/driver/${currentUser.id}`);
            } else {
                response = await api.get("/api/trips");
            }

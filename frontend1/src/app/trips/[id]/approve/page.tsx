...
export default function ApproveTripPage() {
    ...
    const fetchVehicles = async () => {
        try {
            const res = await api.get("/api/trips/available-vehicles");
    ...
    const fetchDrivers = async () => {
        try {
            const res = await api.get("/api/trips/available-drivers");
            setDrivers(res.data);
        } catch (err) {
    ...
    const handleApprove = async () => {
        ...
        try {
            await api.patch(`/api/trips/${id}/approve`, {
    ...
    const handleReject = async () => {
        ...
        try {
            await api.patch(`/api/trips/${id}/reject`, form);
            router.push(`/trips/${id}`);
        } catch (err: any) {

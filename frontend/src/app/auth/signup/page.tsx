...
function SignupContent() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-slate-50/30 to-white">
      ...
      {/* Main Content */}
      <div className="relative flex items-center justify-center min-h-screen px-4 sm:px-6 pt-20 pb-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-slate-600 font-medium max-w-xs mx-auto">
              Join VFMS and manage your fleet operations professionally
            </p>
          </div>
          ...
          <p className="text-center text-xs text-slate-500 mt-8">
            ...
            <Link href="/auth/login" className="font-semibold text-slate-900 hover:text-amber-600 transition-colors duration-200">
              Sign in here
            </Link>
          </p>
        </div>
